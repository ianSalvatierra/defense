...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        self.app_name = "LEXUS TEXT EDITOR"
        self.setWindowTitle(self.app_name)
        self.setWindowIcon(QtGui.QIcon('./icons/industrial-robot.png'))
    ...
    def set_up_menu(self):
        ...
        run_action = system_menu.addAction("Run")
        run_action.setShortcut("F11")
        run_action.triggered.connect(self.run)

        stop_action = system_menu.addAction("Stop")
        stop_action.setShortcut("F10")
        stop_action.triggered.connect(self.stop)

        system_menu.addSeparator()

        back_action = system_menu.addAction("Back")
        back_action.setShortcut("Esc")
    ...
    def set_up_body(self):
        ...
        search_label = self.get_side_bar_label("./icons/loupe.png", "search-icon")
        ...
        self.search_list_view.setFont(QFont("Consolas", 12))
    ...
    def show_dialog(self, title, msg) -> int:
        ...
        dialog.setWindowIcon(QIcon("./icons/text.png"))
        dialog.setText(msg)
    ...
    def back(self):
        self.main_panel = QtWidgets.QMainWindow()
        self.ui = Ui_MainWindow()
        self.ui.setupUi(self.main_panel)
